"""
Consolidate the existing local geopotential zarr stores in this folder into a
single zarr3 store on S3, geopotential/geopotential.zarr, with each source
...
GEOPOTENTIAL_DIR = os.path.dirname(os.path.abspath(__file__))

S3_KEY = ""
S3_SECRET = ""

OUT_PATH = "destine-climate-dt/geopotential/geopotential.zarr"

SOURCE_STORES = [
    "IFS_FESOM_sn_tplus.zarr",
...
def main():
    ...
    for store_name in SOURCE_STORES:
        ...
        src_path = os.path.join(GEOPOTENTIAL_DIR, store_name)
